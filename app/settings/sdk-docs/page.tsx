      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl md:text-2xl font-semibold">SDK Documentation</h2>
              <p className="text-xs sm:text-sm text-muted-foreground">Version {WIDGET_VERSION}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Button onClick={downloadDocs} size="sm" className="text-xs sm:text-sm h-8 sm:h-9">
